...
class CTL_Evaluateur:
    ...
    def EU(self,formula):
        ...
        self.verified_formulas[formula] = any([val for _,val in self.markings[formula].items()])
    ...
    def AU(self,formula):
        ...
        print("Fromule :", formula ,self.markings[formula].items())
...
# Vérifiez les formules CTL pour chaque état initial
    formules_a_verifier = [
        # ('EX', ('ID', 'P')),
        # ('EX', ('^', ('ID', 'P'), ('ID', 'Q'))),
        # ('E', ('U', ('not', ('ID', 'Q')), ('v', ('ID', 'P'), ('ID', 'Q')))),
        # ('E', ('U', ('v', ('ID', 'P'), ('ID', 'Q')), ('^', ('ID', 'Q'), ('not', ('ID', 'P'))))),
        ('A', ('U', ('EX', ('ID', 'P')), ('A', ('U', ('ID', 'P'), ('not', ('ID', 'Q'))))))
    ]
    ...
    for formule in formules_a_verifier:
        ...
        if CTL_e.verified_formulas[formule]:
            print(f'Formule ' , rang_formule ,' : Vrai 🤩')
            print()
            print()
        else:
            print(f'Formule ' , rang_formule ,' : Faux 🥺')
            print()
            print()
        rang_formule += 1
